...
static double __pyx_f_15integrate_nogil_integrate_cos_core(double, double, int); /*proto*/
...
/* #### Code section: decls ### */
static PyObject *__pyx_pf_15integrate_nogil_integrate_cos_nogil(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter); /* proto */
...
#define __pyx_n_u_integrate_cos_nogil __pyx_string_tab[8]
...
#define __pyx_n_u_n_iter __pyx_string_tab[14]
...
#define __pyx_kp_b_iso88591_A_Qc_A __pyx_string_tab[22]
...
static double __pyx_f_15integrate_nogil_integrate_cos_core(double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter) {
  double __pyx_v_acc;
  double __pyx_v_step;
  int __pyx_v_i;
  double __pyx_r;
...
*/
  ...
  __Pyx_AddTraceback("integrate_nogil.integrate_cos_core", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __Pyx_PyGILState_Release(__pyx_gilstate_save);
  __pyx_L0:;
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_15integrate_nogil_1integrate_cos_nogil(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
PyDoc_STRVAR(__pyx_doc_15integrate_nogil_integrate_cos_nogil, "\320\230\320\275\321\202\320\265\320\263\321\200\320\270\321\200\321\203\320\265\321\202 cos(x) \320\275\320\260 [a, b] \320\261\320\265\320\267 GIL.");
static PyMethodDef __pyx_mdef_15integrate_nogil_1integrate_cos_nogil = {"integrate_cos_nogil", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_15integrate_nogil_1integrate_cos_nogil, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_15integrate_nogil_integrate_cos_nogil};
static PyObject *__pyx_pw_15integrate_nogil_1integrate_cos_nogil(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_RefNannySetupContext("integrate_cos_nogil (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "integrate_cos_nogil", 0) < (0)) __PYX_ERR(0, 15, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("integrate_cos_nogil", 0, 2, 3, i); __PYX_ERR(0, 15, __pyx_L3_error) }
      }
    } else {
      switch (__pyx_nargs) {
        case  3:
    ...
    __pyx_v_a = __Pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_a == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 15, __pyx_L3_error)
    __pyx_v_b = __Pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_b == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 15, __pyx_L3_error)
    if (values[2]) {
      __pyx_v_n_iter = __Pyx_PyLong_As_int(values[2]); if (unlikely((__pyx_v_n_iter == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 15, __pyx_L3_error)
    } else {
      __pyx_v_n_iter = ((int)((int)0x186A0));
    }
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("integrate_cos_nogil", 0, 2, 3, __pyx_nargs); __PYX_ERR(0, 15, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("integrate_nogil.integrate_cos_nogil", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_15integrate_nogil_integrate_cos_nogil(__pyx_self, __pyx_v_a, __pyx_v_b, __pyx_v_n_iter);
...
static PyObject *__pyx_pf_15integrate_nogil_integrate_cos_nogil(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("integrate_cos_nogil", 0);
...
*/
  ...
  __pyx_t_1 = __pyx_f_15integrate_nogil_integrate_cos_core(__pyx_v_a, __pyx_v_b, __pyx_v_n_iter); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 17, __pyx_L1_error)
 ...
 *     return integrate_cos_core(a, b, n_iter)
*/
  __pyx_t_2 = __Pyx_PyLong_From_int(((int)0x186A0)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = PyTuple_Pack(1, __pyx_t_2); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_15integrate_nogil_1integrate_cos_nogil, 0, __pyx_mstate_global->__pyx_n_u_integrate_cos_nogil, NULL, __pyx_mstate_global->__pyx_n_u_integrate_nogil, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  ...
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_integrate_cos_nogil, __pyx_t_2) < (0)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{19},{20},{1},{18},{1},{18},{8},{19},{15},{13},{5},{8},{10},{6},{8},{3},{12},{12},{10},{8},{6},{19}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (223 bytes) */
const char* const cstring = "BZh91AY&SYo\273\325\212\000\000\005\377\263D\010\010\002\000\005\000\000\244\001p\000\277\257\377`\000@@@@\000@\0000\000\2531\023(h\000\000\006\200fP\211\352\230\232=@\000\000\003M\003\"\023)\351\250\3615\014\206\2004\003\244\020\2375\255\233Q\002\034\252F\220\n\022\204C\306v\307<\341h\306\017\224B4\306J\201D\264\221(u\007-w\314G\217\241\206kX\020\236\301\325K|\323\202I\202\245\276\245\n\004\211i\215*6H\251\323\351\263\247\020\276\3316A\027\001\255V\014F\241\353s\232\217Qvm,(\005\252x\336x\n\277\024\225*\\#z\272oZ&r\256\346\207\032\030\210`\021\"\306\035h\005\336\022\234\343\203\222\263HZ\337\305\334\221N\024$\033\356\365b\200";
    PyObject *data = __Pyx_DecompressString(cstring, 223, 2);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #elif (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (177 bytes) */
const char* const cstring = "x\332]\216A\n\302@\014E]\270s\351\332\033\210W\220\202kQ/\360I\323X\006\2473\265\223\221\366&.\273\3648\036\301\243\030\250(\230\305\377\371|x\311\326\005\225\272#\025\204X;\277i\207\0368\230\034\206\235c\305^z=\311\231(\r\201]\334p\354bV\027$\225\354\315\340\002\264#\226\222\370\002\234s`\340\007\345\230&\360\337\035\270\204/\312\2514\th\310X6M\254\262\027 \300\212\316\234\032Kml\201k&?E \211~*\333*{1{\005T\222\351\215|\226\364\234\255\037\305k\276x.V\367\343\235\307\345X\274\001\253\240a\001";
    PyObject *data = __Pyx_DecompressString(cstring, 177, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (240 bytes) */
const char* const bytes = "?integrate_nogil.pyx__Pyx_PyDict_NextRefaasyncio.coroutinesbcline_in_traceback__func__integrate_cos_nogilintegrate_nogil_is_coroutineitems__main____module__n_iter__name__pop__qualname____set_name__setdefault__test__values\320\000,\250A\340\004\013\320\013\035\230Q\230c\240\023\240A";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_integrate_nogil_pyx, __pyx_mstate->__pyx_n_u_integrate_cos_nogil, __pyx_mstate->__pyx_kp_b_iso88591_A_Qc_A, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
